...
- Tests unitaires et plans de test : https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g2b11/blob/master/doc/cahier_de_recette.adoc
- link:doc/diag/schema_denchainement_des_pages.png[Lien vers le schéma d'enchainement des pages]
